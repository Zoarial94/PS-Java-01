...
abstract class PrintBaseClass(var prefix: String) {
    protected fun <T> println(`var`: T) {
        kotlin.io.println(LocalDateTime.now().toString() + " " + ANSI_BLUE + prefix + ANSI_RESET + ": " + `var`)
    }
